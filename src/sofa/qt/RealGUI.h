...
public:
    ...
    static gui::common::BaseGUI* CreateGUI(const char* name, sofa::simulation::Node::SPtr groot = nullptr, const char* filename = nullptr);
...
protected:
    ...
    bool m_fullScreen;
    sofa::qt::viewer::SofaViewer* m_viewer;
...
public:
    ...
    void registerViewer(gui::common::BaseViewer* _viewer) override;

    gui::common::BaseViewer* getViewer() override;
...
protected:
    ...
    void initViewer(gui::common::BaseViewer* _viewer) override;
