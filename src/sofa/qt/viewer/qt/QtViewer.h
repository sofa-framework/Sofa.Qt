...
public:
    ...
    static QtViewer* create(QtViewer*, gui::common::BaseViewerArgument& arg)
    {
        gui::common::BaseViewerArgument* pArg = &arg;
        const gui::common::ViewerQtArgument* viewerArg = dynamic_cast<gui::common::ViewerQtArgument*>(pArg);
        return viewerArg ?
...
public slots:
    ...
    virtual void drawColourPicking (gui::common::ColourPickingVisitor::ColourCode code) override ;
