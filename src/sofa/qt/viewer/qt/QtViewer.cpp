...
#include <sofa/qt/viewer/qt/QtViewer.h>
...
#include <sofa/qt/viewer/GLBackend.h>
...
void QtViewer::initializeGL(void)
{
    ...
    if (!initialized)
    {
        //std::cout << "progname=" << sofa::qt::progname << std::endl;
        //sofa::helper::system::SetDirectory cwd(sofa::helper::system::SetDirectory::GetProcessFullPath(sofa::qt::progname));
