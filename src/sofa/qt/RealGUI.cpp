...
using sofa::qt::QtDataRepository;
...
void RealGUI::showAbout()
{
    ...
    AboutSOFADialog* aboutSOFA_dialog = new sofa::qt::AboutSOFADialog(this);
...
void RealGUI::registerViewer(BaseViewer* _viewer)
{
    ...
    sofa::qt::viewer::SofaViewer* tmpViewer = dynamic_cast<sofa::qt::viewer::SofaViewer*>(_viewer);
    if(tmpViewer != nullptr)
    {
        const sofa::qt::viewer::SofaViewer* old = m_viewer;
        m_viewer = tmpViewer;
        delete old;
    }
    else
    {
        msg_error("RealGUI")<<"when registerViewer, the viewer can't be cast as sofa::qt::viewer::SofaViewer*";
    }
}
...
sofa::qt::viewer::SofaViewer* RealGUI::getSofaViewer()
{
    return m_viewer;
}
...
void RealGUI::initViewer(BaseViewer* _viewer)
{
    ...
    sofa::qt::viewer::SofaViewer* sofaViewer = dynamic_cast<sofa::qt::viewer::SofaViewer*>(_viewer);
    if( sofaViewer == nullptr )
    {
        msg_error("RealGUI") << "initViewer failed as given _viewer is not of type sofa::qt::viewer::SofaViewer*";
    }
    else
    {
